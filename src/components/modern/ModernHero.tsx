    ...
    <section id="home" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-vampeta-gold rounded-full"></div>
          <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-vampeta-gold rounded-full"></div>
          <div className="absolute bottom-1/4 left-1/3 w-1 h-1 bg-vampeta-gold rounded-full"></div>
